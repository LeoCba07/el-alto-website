...
const variantStyles: Record<ButtonVariant, string> = {
  primary:
    'bg-[var(--color-amber-light)] text-[var(--color-text-dark)] hover:bg-[var(--color-amber-pale)] shadow-md hover:shadow-lg transition-all hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-[var(--color-amber)] focus:ring-offset-2',
  secondary:
