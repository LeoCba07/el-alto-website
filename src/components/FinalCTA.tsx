  ...
  return (
    <section className="relative py-32 md:py-44 overflow-hidden">
      ...
      <FadeUp className="relative z-10 max-w-3xl mx-auto px-4 text-center text-white">
        ...
        <Link
          href="/contacto"
          className="inline-flex items-center justify-center gap-2 bg-amber-light text-text-dark px-8 py-4 rounded-full font-semibold text-lg hover:bg-amber-pale transition-all hover:shadow-lg hover:shadow-amber/25 hover:scale-105"
        >
