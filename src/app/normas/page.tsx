...
import { MdOutlinePool, MdOutlinePets, MdOutlineLocalParking, MdOutlineWaterDrop } from 'react-icons/md'
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl border border-sand overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex gap-4">
                  <MdOutlinePets className="w-6 h-6 text-amber flex-shrink-0 mt-0.5" />
                  <div>
